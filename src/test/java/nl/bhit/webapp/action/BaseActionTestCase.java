...
@ContextConfiguration(
		locations = { "classpath:/applicationContext-resources.xml", "classpath:/applicationContext-dao.xml", "classpath:/applicationContext-service.xml",
...
public abstract class BaseActionTestCase extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void logUserIntoSession(final User user) {
		...
		final UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(user.getUsername(), user.getConfirmPassword(),
				user.getAuthorities());
